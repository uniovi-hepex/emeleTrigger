plots = {
   ...
   'muonPropEta' : {'variable'   : 'muonPropEta',
    ...
    'stubPhi' : {'variable'   : 'stubPhi',
                    ...
                    'extra cuts' : ['(stubLayer!=1)', '(stubLayer!=3)', '(stubLayer!=5)'], # Applied at per object level only in this plot
                    #Plotting thingies
                    'xlabel'     : '$\phi$ (stubs)',
                    'ylabel'     : 'Yields',
                    'xrange'     : [-1000,1000],
    ...
    'stubEta' : {'variable'   : 'stubEta',
                    ...
                    'extra cuts' : '(stubLayer.any()!=1) & (stubLayer!=3) & (stubLayer!=5)', # Applied at per object level only in this plot
                    #Plotting thingies
                    'xlabel'     : '$\eta$ (stubs)',
                    'ylabel'     : 'Yields',
                    'xrange'     : [70,140],
    ...
    'stubEtaDist' : {'variable'   : 'stubEtaDist',
                      'bins'       : 100,
                      'extra cuts' : '(stubLayer!=1) & (stubLayer!=3) & (stubLayer!=5)',
                      'xlabel'     : 'stubEtaDist',
                      'ylabel'     : 'Yields',
                      'xrange'     : [0,200],
                      'ExtraSpam'  :  "",
