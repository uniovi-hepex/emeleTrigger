...
files_SingleMu_DUMP  = (phedexPath + "data/SingleMu_l1omtf_Dump.root", "simOmtfPhase2Digis/OMTFHitsTree") # Muo
...
datasets = {
    ...
    'MuGun_DUMP'  : {'name'       : 'MuGun_DUMP', # Name of the dataset
                                  'samples'    : files_SingleMu_DUMP[0], #  FILE
                                  'treename'  : files_SingleMu_DUMP[1], # Is prompt?
                                  'color'     : 'black', # Plotting color
                                  'label'     : "", # Legend label
